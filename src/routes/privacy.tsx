...
function Privacy() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-20">
      <h1 className="text-4xl font-semibold tracking-tight md:text-5xl">Política de privacidade</h1>
      <p className="mt-3 text-sm text-muted-foreground">Última atualização: maio de 2026</p>

      <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
        <section>
          <h2 className="text-base font-medium text-foreground">Dados que recolhemos</h2>
        ...
        <section>
          <h2 className="text-base font-medium text-foreground">Utilização dos dados</h2>
