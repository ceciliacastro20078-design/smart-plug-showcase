...
function Shipping() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-20">
      <h1 className="text-4xl font-semibold tracking-tight text-[#425742] md:text-5xl">Entregas e devoluções</h1>

      <div className="mt-10 space-y-10 text-sm leading-relaxed text-muted-foreground">
        <section>
          <h2 className="text-base font-medium text-foreground text-[#425742]">Entregas</h2>
        ...
        <section>
          <h2 className="text-base font-medium text-foreground text-[#425742]">Devoluções</h2>
        ...
        <section>
          <h2 className="text-base font-medium text-foreground text-[#425742]">Reembolsos</h2>
        ...
        <section>
          <h2 className="text-base font-medium text-foreground text-[#425742]">Garantia</h2>
